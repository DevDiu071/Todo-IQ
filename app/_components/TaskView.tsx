      ...
      <div className="border border-border-color rounded-xl px-5 py-2">
        <div className="flex gap-x-4 items-end">
          <div className="relative aspect-square h-24">
            <Image src={cardImg} fill alt="banner" className="object-cover" />
          </div>
          <div className="leading-loose">
            <p className="text-md font-semibold">Walk the dog</p>
            <p className="text-xs leading-relaxed">
              Priority: <span className="text-red">Extreme</span>
            </p>
            <p className="text-xs leading-relaxed">
        ...
        <p className="mt-4 text-sm text-gray">Take the dog to work</p>
        <p className="mt-5 text-sm text-gray">
          ...
          they need for a happy and healthy day. Don&apos;t forget to bring
          along squeaky and fluffy for some extra fun along the way!
        </p>
        ...
        <div className="flex items-center gap-x-2 justify-end mt-14">
          <button>
            <svg
